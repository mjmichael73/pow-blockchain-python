...
from blockchain_client.api.routes import router
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-p",
        "--port",
        default=int(os.getenv("BLOCKCHAIN_CLIENT_PORT", 8081)),
        type=int,
    ...
    uvicorn.run("blockchain_client.main:app", host=host, port=port, reload=True)
